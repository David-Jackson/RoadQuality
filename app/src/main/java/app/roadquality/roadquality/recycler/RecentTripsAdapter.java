package app.roadquality.roadquality.recycler;
...
import app.roadquality.roadquality.recycler.holders.NoTripsViewHolder;
import app.roadquality.roadquality.recycler.holders.ShareViewHolder;
import app.roadquality.roadquality.recycler.holders.TripViewHolder;
import app.roadquality.roadquality.utils.OnClickListenerWithCoordinates;
    ...
    private void onBindTripViewHolder(final TripViewHolder holder, final int position) {
        ...
        holder.layout.setOnTouchListener(new OnClickListenerWithCoordinates() {
            ...
            public void onClick(float clickX, float clickY) {
                ...
                notifyItemChanged(oldActiveTripPosition);
                notifyItemChanged(activeTripPosition);
            }
        });
    }
